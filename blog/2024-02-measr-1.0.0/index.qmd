...
image: "featured.jpg"
image-alt: "Different colored measurement tape"
...
We are thrilled to announce the release of [measr](https://measr.info) 1.0.0.
...
This includes the *M<sub>2</sub>* statistic [@liu2016], as well as posterior predictive model checks for evaluating both overall and item-level model fit [@sinharay2007; @thompson-bayes].
...
In this case study, data from the *Examination for the Certificate of Proficiency in English* (ECPE), which has been widely used in the DCM literature [e.g., @ecpe].
...
If you are interested in learing more about measr and diagnostic models, we hosted a workshop in June at [StanCon 2023](https://mc-stan.org/events/stancon2023/).
...
Finally, if you are interested in attending a workshop in person, we'll be teaching another workshop in April at the 2024 annual meeting of the National Conference on Measurement in Education (NCME).
